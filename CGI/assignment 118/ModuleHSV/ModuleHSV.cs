...
namespace Modules
{
  public class ModuleHSV : DefaultRasterModule
  {
    ...
    /// </summary>
    public override string Tooltip => "[hue-off] [circle n|square n]";
    ...
    protected void recompute ()
    {
          ...
          inImage != null)
      {
        ...
        if (dirty)
        {
          HSV.Compute(workingImg, Param);
          dirty = false;
        }
        HSV.DrawImage(hImage);
        //hImage.Save("C:\\obr.png");
        hForm.SetBuffer(hImage);
      }
    }
