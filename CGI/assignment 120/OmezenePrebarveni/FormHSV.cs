...
namespace Modules
{
  public partial class FormHSV : Form
  {
    ...
    public PropertyGrid paramsGrid;
    ...
    public FormHSV (IRasterModule hModule)
    {
      module = hModule;
      InitializeComponent();
      paramsGrid.SelectedObject = OmezenePrebarveni.MyParams;
    }
    ...
    private void ignoreSkinChckBox_CheckedChanged (object sender, EventArgs e) => dirty = true;
  }
}
